(() => {
  ...
  async function loadWeather() {
    ...
    try {
      ...
      /*
        Do not overwrite current readings if the visitor changes locations
        before a previous weather request has completed.
      */
      ...
      state.targetSpeed = Math.max(0.08, Math.min(1.65, state.windSpeed / 17));
